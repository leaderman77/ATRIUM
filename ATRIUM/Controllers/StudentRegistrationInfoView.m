...
@interface StudentRegistrationInfoView ()<UITextFieldDelegate, UIActionSheetDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate>
@property (nonatomic, strong) DateTimePicker* picker;
@end
@implementation StudentRegistrationInfoView
...
- (CustomTextField *)textFieldWithFrame:(CGRect)frame withArrow:(BOOL)flag {
    ...
    textField.backgroundColor = rgbColor(236, 243, 249);
    ...
    textField.textColor = rgbColor(0, 164, 234);
