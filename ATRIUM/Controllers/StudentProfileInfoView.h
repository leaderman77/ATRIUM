...
@protocol StudentProfileInfoViewDelegate <NSObject>
...
@interface StudentProfileInfoView : BaseInfoView
...
@property (nonatomic, weak) id <StudentProfileInfoViewDelegate> studentProfileInfoViewDelegate;
