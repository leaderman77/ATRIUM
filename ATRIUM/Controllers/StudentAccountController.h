...
@protocol StudentProfileDelegate <NSObject>
...
@interface StudentAccountController : BaseController
@property (nonatomic, assign) BOOL isViewMode;
@property (nonatomic, weak) id <StudentProfileDelegate> studentProfileDelegate;
